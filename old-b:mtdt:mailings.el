...
(defun b:mtdt:compositionModel/select (<model)
  "Based on <model, select composition model."
  (cond
...
(defun b:mtdt:compose:framework/setup (<framework)
  "Based on <framework, set things up for composition."
  (cond
